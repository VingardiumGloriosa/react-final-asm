...
export const login = (email: string, password: string) => {
    return async (dispatch: any, getState: any) => {
        ...
        const response = await fetch('https://identitytoolkit.googleapis.com/v1/accounts:signInWithPassword?key=AIzaSyBIZyPwvyODNGARuUdFP-RhsAPyha4K0qM', {
            method: 'POST',
            headers: {
                'Content-Type': 'application/json'
            },
...
export const signup = (email: string, password: string) => {
    return async (dispatch: any, getState: any) => {
        ...
        const response = await fetch('https://identitytoolkit.googleapis.com/v1/accounts:signUp?key=AIzaSyBIZyPwvyODNGARuUdFP-RhsAPyha4K0qM', {
            method: 'POST',
            headers: {
                'Content-Type': 'application/json'
            },
...
export const changePassword = (password: string) => {
    return async (dispatch: any, getState: any) => {
        ...
        const response = await fetch('https://identitytoolkit.googleapis.com/v1/accounts:update?key=AIzaSyBIZyPwvyODNGARuUdFP-RhsAPyha4K0qM', {
            method: 'POST',
            headers: {
                'Content-Type': 'application/json'
            },
...
export const updateEmail = (email: string) => {
    return async (dispatch: any, getState: any) => {
        const idToken = refreshTokenToIdToken;
